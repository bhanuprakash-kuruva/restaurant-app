...
//       try {
//         const response = await fetch('https://restaurant-app-backend-mu.vercel.app//chef/showchefs');
//         if (!response.ok) {
...
//               <CardMedia component="img" height="200" image={`https://restaurant-app-backend-mu.vercel.app/${c.imageURL}`} alt={c.name} />
//               <CardContent>
