...
//       const response = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//item/addItem', {
//         method: 'POST',
//         body: newFormData,
//       });
...
const AddItem = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//admin/addItem', {
        method: 'POST',
        body: newFormData,
      });
