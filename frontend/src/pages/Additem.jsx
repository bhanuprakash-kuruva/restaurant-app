...
//       const response = await fetch('https://restaurant-app-three-pied.vercel.app//item/addItem', {
//         method: 'POST',
//         body: newFormData,
//       });
...
const AddItem = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://restaurant-app-three-pied.vercel.app//admin/addItem', {
        method: 'POST',
        body: newFormData,
      });
