...
//         // Fetch chefs data
//         const chefsResponse = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//chef/showchefs');
...
//         console.log(chefs)
//         // Fetch items data
//         const itemsResponse = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//item/menu-items');
//         if (!itemsResponse.ok) throw new Error('Failed to fetch items data');
//         const itemsData = await itemsResponse.json();
//         setItems(itemsData);
//         console.log(items)

//         const deliveryBoyResponse = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//deliveryboy/show')
...
//       try {
//         const response = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//catering/getEvents');
//         if (response.ok) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const chefsRes = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//chef/showchefs');
        if (!chefsRes.ok) throw new Error('Failed to fetch chefs data');
        const chefsData = await chefsRes.json();
        setChefs(chefsData.chef);

        const itemsRes = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//item/menu-items');
        if (!itemsRes.ok) throw new Error('Failed to fetch items data');
        const itemsData = await itemsRes.json();
        setItems(itemsData);

        const deliveryRes = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//deliveryboy/show');
        if (!deliveryRes.ok) throw new Error('Failed to fetch delivery boys');
        const deliveryData = await deliveryRes.json();
        setDeliveryBoys(deliveryData.deliverboys);

        const eventsRes = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//catering/getEvents');
        if (eventsRes.ok) {
