...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const fetchUserDetails = async () => {
      try {
        const response = await fetch(`https://restaurant-app-backend-mu.vercel.app//customer/profile/${e}`);
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchMenuItems = async () => {
      try {
        const response = await fetch('https://restaurant-app-backend-mu.vercel.app//item/menu-items'); // replace with your API endpoint
        if (!response.ok) {
  ...
  const handleRemoveFromWishlist = async (itemId) => {
    try {
      ...
      const response = await fetch(`https://restaurant-app-backend-mu.vercel.app//customer/remove-wishlist-item/${email}`, {
        method: 'PUT',
  ...
  const handleSaveChanges = async () => {
    try {
      const response = await fetch(`https://restaurant-app-backend-mu.vercel.app//profile/update/${email}`, {
        method: 'PUT',
        headers: {
