...
const SalesAndItemsAnalysis = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//orders/deliveryboy/showorders');
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchRatings = async () => {
      try {
        const response = await fetch('https://restaurant-6xfaogsc7-kuruva-bhanu-praashs-projects.vercel.app//reviews/showreviews'); // Replace with your API endpoint for ratings
        if (!response.ok) {
